...
import phoneIcon from '../../public/images/image copy 2.png';
    ...
    return (
        <>
            ...
            <motion.a
                ...
                style={{
                    position: 'fixed',
                    bottom: '105px', // Positioned directly above the WhatsApp button (30px + 60px + 15px margin)
                    right: '30px',
                    width: '60px',
                    height: '60px',
                    borderRadius: '50%',
                    ...
                    cursor: 'pointer',
                    overflow: 'hidden',
                    background: '#0084FF' // Fallback blue
                }}
                title="Call Us Now"
            >
                <Image 
